...
function createInfoElement({ title, author, category, price, delivery, image_url, desc, reviews }) {
  ...
  const book_info = criarElemento('div', {
    className: 'book-info',
    children: [
      criarElemento('img', { attributes: { src: image_url, alt: 'capa do livro', class: 'book-image' } }),
      criarElemento('div', {
        ...
        children: [
          ...
          criarElemento('div', {
            ...
            children: [
              ...
              criarElemento('div', { className: 'book-details-rate-stars', children: starRatingElements }),
              criarElemento('p', { text: `(${formatarNumero(reviewsAmount)})`, className: 'book-details-rate-amount' }),
            ],
          }),
          criarElemento('p', { text: `<strong>Autor do Livro:</strong> ${author}`, className: 'book-details-author' }),
          criarElemento('p', { text: `<strong>Categoria:</strong> ${category}`, className: 'book-details-author' }),
          criarElemento('div', {
    ...
    children: [
      criarElemento('div', {
        ...
        children: [
          ...
          criarElemento('p', { text: formatarDinheiroComDesconto(price), className: 'purchase-price-promotion' }),
          criarElemento('p', {
            text: `originalmente por <span class='purchase-price-original-amount'>${formatarDinheiro(price)}</span>` ,
      ...
      criarElemento('div', {
        ...
        children: [
          criarElemento('p', {
            text: `<strong>Entrega:</strong> ${delivery.amount == 0 ? 'GRÁTIS' : formatarDinheiro(delivery)}`
          }),
          criarElemento('p', {
            text: `Estimativa de entrega <strong>${calcularDataComDias(delivery.days)}</strong>`,
            className: 'purchase-shipping-estimated',
          }),
          criarElemento('p', { text: 'entrega para todo o país!', className: 'purchase-shipping-radius' }),
        ],
      }),
      criarElemento('div', {
        ...
        children: [
          ...
          criarElemento('input', { attributes: { type: 'number', placeholder: '1', value: '1', min: 1, max: 10 } })
        ],
      }),
      criarElemento('div', {
        ...
        children: [
          ...
          criarElemento('div', { text: 'Adicionar ao Carrinho', className: 'purchase-button bg--purple-3' }),
        ],
      }),
    ],
  });
